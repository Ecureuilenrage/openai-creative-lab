const ui = {
  fr: {
    navSoulborn: "Soulborn",
    navTarot: "Tarot",
    navToolchain: "Outils",
    navArchive: "Archives",
    heroEyebrow: "OpenAI Creative Lab · Final Render",
    heroTitle: "Une page bilingue qui ouvre sur le résultat, puis remonte vers le processus.",
    heroCopy:
      "Soulborn et Tarot sont présentés comme un journal de recherche honnête : inspirations, panne créative, itérations retenues, outils utilisés, et emplacements déjà posés pour les captures manquantes.",
    heroPrimaryCta: "Entrer dans Soulborn",
    heroSecondaryCta: "Entrer dans Tarot",
    heroDriveCta: "Ouvrir l'archive Drive",
    heroMetaJournal: "Journal honnête",
    heroMetaBilingual: "FR / EN intégral",
    heroMetaResultFirst: "Résultat d'abord",
    heroMetaLocalMedia: "Médias locaux branchés",
    portalSoulbornLabel: "Chapitre 01",
    portalSoulbornTitle: "Soulborn",
    portalSoulbornCopy:
      "Voyageur, monolithe, mondes successifs, sept soleils, puis soleil unique. Le trailer reste le cœur du rendu.",
    portalTarotLabel: "Chapitre 02",
    portalTarotTitle: "Tarot",
    portalTarotCopy:
      "Évolution de Lapin Interactive, expérimentations vitrail puis pivot vers un deck vidéo minimaliste et une expérience plus lisible.",
    overviewEyebrow: "Cadre éditorial",
    overviewTitle: "Ce que cette page doit montrer",
    soulbornEyebrow: "Soulborn",
    soulbornTitle: "Le trailer officiel : voyageur, monolithe, mondes successifs",
    soulbornLead:
      "La narration reste honnête : inspiration littéraire, panne de créativité, tests de natures mortes et d'autres capacités de Sora, puis retour vers une scène qui venait directement de la lecture en cours.",
    statusAvailable: "Disponible localement",
    soulbornFeatureTag: "Trailer final",
    soulbornFeatureTitle: "V1 trailer Soulborn",
    soulbornFeatureCopy:
      "Ouverture sur le résultat final actuel avant de revenir au making-of, aux itérations d'images et au montage.",
    statusCurated: "Narration cadrée",
    soulbornNarrativeTag: "Axe de récit",
    soulbornNarrativeTitle: "Angle éditorial retenu",
    soulbornNarrativePoint1:
      "Partir de l'inspiration littéraire, puis expliquer la panne de créativité et le besoin de tester Sora sur plusieurs terrains avant de trouver la bonne forme.",
    soulbornNarrativePoint2:
      "Dire clairement que le monde couvert d'eau et les sept soleils posaient un problème visuel difficile parce que ces combinaisons existent peu dans les références vues par les modèles.",
    soulbornNarrativePoint3:
      "Montrer le pivot comme une décision productive : ajouter un objet ou une présence animée rend la scène plus lisible et plus vivante.",
    statusPrompt: "Prompt documenté",
    sunoTitle: "Direction musicale retenue",
    sunoCopy:
      "Le trailer s'appuie sur la piste choisie dans le document de travail Suno, avec un rythme pensé pour les transitions rapides entre mondes.",
    tarotEyebrow: "Tarot",
    tarotTitle: "Lapin Interactive : de l'expérimentation vitrail au deck minimaliste",
    tarotLead:
      "Le chapitre Tarot montre moins un seul climax final qu'une évolution de direction : une série d'essais visuels, un recul sur ce qui marchait vraiment, puis un deck vidéo plus cohérent pour l'expérience interactive.",
    statusPlaceholder: "Placeholder prêt",
    tarotFeatureTag: "Expérience finale",
    tarotFeatureTitle: "Vidéo ou capture finale du tarot à ajouter",
    tarotFeatureCopy:
    ...
    tarotNarrativePoint1:
      "Montrer l'évolution de Lapin Interactive plutôt qu'un simple catalogue de cartes.",
    tarotNarrativePoint2:
      "Expliquer que les premières tentatives vidéo en vitrail ont été conservées comme images dans le projet, mais pas comme direction finale pour les clips.",
    tarotNarrativePoint3:
      "Mettre en avant le deck minimaliste comme décision de lisibilité, de cohérence et d'efficacité pour l'expérience finale.",
    tarotSamplesTag: "Mini-exemples",
    tarotSamplesTitle: "Mini-exemples répartis sur plusieurs cartes",
    tarotSamplesCopy:
      "La page est pensée pour montrer plusieurs points du projet plutôt qu'un seul bloc massif : cartes, prompts, évolution de l'interface, bulk iterations et captures d'outils.",
    toolchainEyebrow: "Toolchain",
    toolchainTitle: "Fiche technique des applications mentionnées",
    toolchainLead:
      "Chaque outil est présenté selon le même angle : rôle, input, output, raison du choix, limites et résultat concret dans le rendu.",
    archiveEyebrow: "Archives & Recherche",
    archiveTitle: "Preuves de recherche, dossiers et emplacements encore à compléter",
    archiveLead:
      "Cette dernière partie regroupe le graphe Obsidian, l'archive Drive, le pipeline NanoBanana, et les placeholders déjà posés pour les captures pas encore rangées.",
    footerCredit: "Autorisation de partage de mon travail avec crédits @ex0niq",
    openLink: "Ouvrir",
  ...
  en: {
    navSoulborn: "Soulborn",
    navTarot: "Tarot",
    navToolchain: "Toolchain",
    navArchive: "Archive",
    heroEyebrow: "OpenAI Creative Lab · Final Render",
    heroTitle: "A bilingual page that opens on the final result, then climbs back through the process.",
    heroCopy:
      "Soulborn and Tarot are framed as an honest research journal: inspirations, creative block, selected iterations, tools used, and already-placed slots for missing captures.",
    heroPrimaryCta: "Enter Soulborn",
    heroSecondaryCta: "Enter Tarot",
    heroDriveCta: "Open the Drive archive",
    heroMetaJournal: "Honest journal",
    heroMetaBilingual: "Full FR / EN",
    heroMetaResultFirst: "Result first",
    heroMetaLocalMedia: "Local media wired in",
    portalSoulbornLabel: "Chapter 01",
    portalSoulbornTitle: "Soulborn",
    portalSoulbornCopy:
      "Traveler, monolith, successive worlds, seven suns, then one sun. The trailer remains the core of the submission.",
    portalTarotLabel: "Chapter 02",
    portalTarotTitle: "Tarot",
    portalTarotCopy:
      "Evolution of Lapin Interactive, stained-glass experiments, then a pivot toward a minimalist video deck and a clearer interactive experience.",
    overviewEyebrow: "Editorial frame",
    overviewTitle: "What this page needs to show",
    soulbornEyebrow: "Soulborn",
    soulbornTitle: "The official trailer: traveler, monolith, successive worlds",
    soulbornLead:
      "The narrative stays honest: literary inspiration, creative block, still-life tests and other Sora capabilities, then a return to a scene directly inspired by the book currently being read.",
    statusAvailable: "Available locally",
    soulbornFeatureTag: "Final trailer",
    soulbornFeatureTitle: "V1 Soulborn trailer",
    soulbornFeatureCopy:
      "The page opens on the current final result before returning to the making-of, image iterations, and editing process.",
    statusCurated: "Curated narrative",
    soulbornNarrativeTag: "Story frame",
    soulbornNarrativeTitle: "Chosen editorial angle",
    soulbornNarrativePoint1:
      "Start with the literary inspiration, then explain the creative block and the need to test Sora across multiple directions before finding the right form.",
    soulbornNarrativePoint2:
      "Say clearly that a water-filled world with seven suns was visually difficult because those combinations barely exist in the references seen by the models.",
    soulbornNarrativePoint3:
      "Present the pivot as a productive decision: adding an animated object or presence makes the scene clearer and more alive.",
    statusPrompt: "Documented prompt",
    sunoTitle: "Selected music direction",
    sunoCopy:
      "The trailer uses the track selected in the Suno working document, with a rhythm designed for fast transitions between worlds.",
    tarotEyebrow: "Tarot",
    tarotTitle: "Lapin Interactive: from stained-glass experiments to a minimalist deck",
    tarotLead:
      "The Tarot chapter shows less of a single final climax and more of a directional evolution: a series of visual tests, a step back on what truly worked, then a more coherent video deck for the interactive experience.",
    statusPlaceholder: "Placeholder ready",
    tarotFeatureTag: "Final experience",
    tarotFeatureTitle: "Final tarot video or capture to add",
    tarotFeatureCopy:
    ...
    tarotNarrativePoint1:
      "Show the evolution of Lapin Interactive rather than a simple gallery of cards.",
    tarotNarrativePoint2:
      "Explain that the early stained-glass video attempts were kept as still images inside the project, but not as the final direction for the clips.",
    tarotNarrativePoint3:
      "Highlight the minimalist deck as a choice for readability, coherence, and efficiency in the final experience.",
    tarotSamplesTag: "Mini examples",
    tarotSamplesTitle: "Mini examples spread across several cards",
    tarotSamplesCopy:
      "The page is designed to show multiple points of the project instead of one massive block: cards, prompts, interface evolution, bulk iterations, and tool captures.",
    toolchainEyebrow: "Toolchain",
    toolchainTitle: "Technical sheet for the mentioned applications",
    toolchainLead:
      "Each tool is presented through the same lens: role, input, output, why it was chosen, limits, and a concrete result inside the final submission.",
    archiveEyebrow: "Archive & Research",
    archiveTitle: "Research evidence, folders, and slots still to complete",
    archiveLead:
      "This final section gathers the Obsidian graph, the Drive archive, the NanoBanana pipeline, and the placeholders already created for captures that are not sorted yet.",
    footerCredit: "Authorized to share my work with credits @ex0niq",
    openLink: "Open",
...
const sunoPrompt =
  "Hybrid orchestral electronic, glitchy synth textures layered with full orchestra, rapid percussive hits, whooshes between sections, each section shifts genre slightly, cinematic trailer music, intense, 110 BPM";

const dataset = {
  overview: [
    {
      title: {
        fr: "Commencer par le résultat",
        en: "Start from the final result",
      },
      copy: {
    ...
    {
      title: {
        fr: "Assumer le journal de recherche",
        en: "Lean into the research journal",
      },
      copy: {
    ...
    {
      title: {
        fr: "Montrer deux projets en miroir",
        en: "Show two mirrored projects",
      },
      copy: {
    ...
    {
      title: {
        fr: "Laisser des traces exploitables",
        en: "Leave usable evidence behind",
      },
      copy: {
  ...
  tarotPlaceholders: [
    ...
    },
    {
      ...
      title: {
        fr: "Évolution de l'app interactive dans VS Code",
  ...
  toolchain: [
    ...
    },
    {
      ...
      fields: {
        ...
        output: {
          fr: "Artefacts de run, images nettoyées, manifestes et événements.",
    ...
    },
    {
      ...
      fields: {
        ...
        result: {
          fr: "À citer dans la documentation créative et la fiche outils.",
  ...
  archive: [
    {
      ...
      title: { fr: "Archive Drive des projets et scripts", en: "Drive archive of projects and scripts" },
      copy: {
    ...
    },
    {
      status: "curated",
      tag: { fr: "Pipeline", en: "Pipeline" },
      title: { fr: "Dossier NanoBanana / bulk-editing", en: "NanoBanana / bulk-editing folder" },
      copy: {
    ...
    },
    {
      ...
      copy: {
        fr: "À insérer ici comme preuve de profondeur de recherche, de brainstorming et de documentation.",
    ...
    },
    {
      ...
      title: { fr: "Médias locaux déjà branchés", en: "Local media already wired in" },
      copy: {
...
function statusMarkup(status, tag, lang) {
  const statusLabel = ui[lang][statusKeys[status]] ?? "";
  const tagText = textFor(tag, lang);
  const statusClass = statusClasses[status] ?? "note";
...
function renderOverview(lang) {
  ...
  container.innerHTML = dataset.overview
    .map(
      (item) => `
...
function renderToolGrid(lang) {
  ...
  const toolKeys = Object.keys(toolLabels);

  container.innerHTML = dataset.toolchain
    .map((item) => {
      const rows = toolKeys
        .map(
          (key) => `
            <div class="tool-row">
              <strong>${escapeHtml(textFor(toolLabels[key], lang))}</strong>
      ...
      const button = item.href
        ? `
          <a
            ...
            rel="noreferrer"
          >
            ${escapeHtml(textFor(item.button, lang) || ui[lang].openLink)}
          </a>
        `
        : "";
...
function applyStaticTranslations(lang) {
  ...
  document.title = "OpenAI Creative Lab Render";
  ...
  if (promptTitle) {
    promptTitle.textContent = promptTitles[lang];
  }

  const promptBody = document.querySelector("#suno-prompt");
  if (promptBody) {
    promptBody.textContent = sunoPrompt;
  }
}
...
function renderDynamicContent(lang) {
  renderOverview(lang);
  renderPills("#soulborn-worlds", dataset.soulbornWorlds, "world-tag", lang);
  renderPills("#tarot-cards", dataset.tarotCards, "card-tag-pill", lang);
  renderMediaGrid("#soulborn-media", dataset.soulbornMedia, lang);
  renderPlaceholderGrid("#soulborn-placeholders", dataset.soulbornPlaceholders, lang);
  renderMediaGrid("#tarot-media", dataset.tarotMedia, lang);
  renderPlaceholderGrid("#tarot-placeholders", dataset.tarotPlaceholders, lang);
  renderToolGrid(lang);
...
function init() {
  ...
  applyLanguage(readStoredLanguage() || "fr");
}
